...
public class ExampleRefreshResourcePoint extends ResourcePoint<ModelObject> {
    ...
    public static boolean post(final Map<String, String> resourcePathParams,
        ...
        return Cannon.fireRefreshRequest(ExampleRefreshResourcePoint.class, Request.Method.POST, resourcePathParams, requestHeaders, requestParams, null, successListener, errorListener);
    }
}
